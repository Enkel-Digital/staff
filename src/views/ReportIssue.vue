<template>
  <div id="form">
    ...
    <p>
      Please contact me <a href="mailto:JJ@enkeldigital.com">here</a>, if not
...
export default {
  ...
  methods: {
    ...
    loadForm(formURL) {
      ...
      formURL =
        "https://docs.google.com/forms/d/e/1FAIpQLScdkyGLJiKJ0fQ0SvwfLwtEsUbqq1Ev_a5RyPy8om2ZqBkchw/viewform?embedded=true";
